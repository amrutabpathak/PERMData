...
<body class="text-center">
	...
	<form action="applicantupdate" method="post" class="form-signin">

		<p>
		<h1 class="h3 mb-3 font-weight-normal">Update An Applicant</h1>
		
		
			<label for="ApplicantID" class="sr-only">ApplicantID</label>
			<input id="ApplicantID" name="ApplicantID" class="form-control" placeholder="ApplicantID" value=""required autofocus>
		<p></p>
		
			<label for="AdmissionClass" class="sr-only">New AdmissionClass</label>
			<input id="AdmissionClass" name="AdmissionClass" class="form-control" placeholder="New AdmissionClass" value=""required autofocus>
		<p></p>
