...
<div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
	...
	<form form action="agentcreate" method="post" class="form-signin">
		<%--<img class="mb-4" src="https://getbootstrap.com/docs/4.0/assets/brand/bootstrap-solid.svg" alt="" width="72" height="72">--%>
		<h1 class="h3 mb-3 font-weight-normal">Create An Agent</h1>

		<label for="agentname" class="sr-only">AgentName</label>
		<%--<input id="agentname" name="agentname" value="${fn:escapeXml(param.agentname)}">--%>
		<input type="agentname" id="agentname" name="agentname" class="form-control" placeholder="Agent Name" value=""required autofocus>
		<p></p>
			<label for="City" class="sr-only">City</label>
			<%--<input id="agentname" name="agentname" value="${fn:escapeXml(param.agentname)}">--%>
			<input type="City" id="City" name="City" class="form-control" placeholder="City" value=""required autofocus>
			<p></p>
			<label for="State" class="sr-only">State</label>
			<%--<input id="agentname" name="agentname" value="${fn:escapeXml(param.agentname)}">--%>
			<input type="State" id="State" name="State" class="form-control" placeholder="State" value=""required autofocus>
