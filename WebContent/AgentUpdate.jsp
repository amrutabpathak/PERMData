...
<div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
	...
	<form action="agentupdate" method="post" class="form-signin">

		<p>
		<h1 class="h3 mb-3 font-weight-normal">Update An Agent</h1>
		...
		<input type="city" id="city" name="city" class="form-control" placeholder="New City" value="${fn:escapeXml(param.agentname)}"required autofocus>
