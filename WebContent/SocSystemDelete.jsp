...
<!-- <title>Delete a SOC System</title> -->
	<meta charset="utf-8">
...
<div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
	...
	<form action="socsystemdelete" method="post" class="form-signin">
		<p>
			<div <c:if test="${messages.disableSubmit}">style="display:none"</c:if>>
				<label for="prevailingwagesoccode" class="sr-only">Soc Code</label>
				<input id="prevailingwagesoccode" name="prevailingwagesoccode" class="form-control" placeholder="Soc Code" value="${fn:escapeXml(param.prevailingwagesoccode)}" required autofocus>
			</div>
		</p>
		<p>
